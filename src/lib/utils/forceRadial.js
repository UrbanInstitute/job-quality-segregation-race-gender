// computes radial and angular forces at the same time (https://observablehq.com/d/9187c989f882beee)
// @ts-nocheck
function center(x, y) {
  var nodes;
...
function radial(radius, x, y, angle) {
  var nodes,
  ...
  force.strength = function (_) {
    return arguments.length
      ? ((strength = value(_) || constant(1)), initialize(), force)
      : strength;
  };
