/**
 * Copied code from https://github.com/micha-lmxt/svelte-textfit - based on react-textfit. Modified to work with Svelte 4. See ./text-fit/ for helper functions.
...
import series from "./text-fit/series";
import whilst from "./text-fit/whilst";
import throttleFun from "./text-fit/throttle";
import uniqueId from "./text-fit/uniqueId";
import { innerWidth, innerHeight } from "./text-fit/innerSize";
...
export const textfit = (node, props) => {
  let { throttle = 10, autoResize = false } = props;
  //state
  let fontSize = null,
    ready = false;
